 ### 我开发了一个AI客户端软件，需要写一个介绍文档。使用wails+antd vue进行开发。特点是只需要一个exe文件就能执行无需安装其它环境。支持AI对话、文件对话、数据库对话、图像对话、提示词管理、本地知识库管理、函数调用等、并能够调用任何兼容openai接口的ai平台。以及本地化部署运行，是已知客户端中最轻量级的AI客户端了
# AI客户端软件介绍
