    ...
    <div>
        <div>
            <a-flex gap="middle" horizontal>
                ...
                <a-input placeholder="提示词名称" v-model:value="query.roleName"></a-input>
...
import { Delete, Page } from '../../../wailsjs/go/biz/PromptBiz.js';


export default {
    mounted() {
        this.query = this.$store.queryData["prompt"] || {};
        this.loadPage();
    },
    data() {
        return {
    ...
    methods: {
        ...
        queryData() {
            this.$store.setQueryData("prompt", this.query);
