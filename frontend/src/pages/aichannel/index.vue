    ...
    <div>
        <div>
            <a-flex gap="middle" horizontal>
                ...
                <a-input placeholder="渠道名称" v-model:value="query.name"></a-input>
...
import { Delete, Page } from '../../../wailsjs/go/biz/AiChannelBiz.js';


export default {
    mounted() {
        this.query = this.$store.queryData["aichannel"] || {};
        this.loadPage();
    },
    data() {
        return {
            ...
            columns: [
                ...
                { title: "认证Token", dataIndex: "token", ellipsis: true },
                { title: "支持模型", dataIndex: "models", ellipsis: true },
    ...
    methods: {
        ...
        queryData() {
            this.$store.setQueryData("aichannel", this.query);
