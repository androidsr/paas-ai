    ...
    <div>
        <div>
            <a-flex gap="middle" horizontal>
                ...
                <a-input placeholder="数据库名称" v-model:value="query.dbname"></a-input>
...
import { Delete, Page } from '../../../wailsjs/go/biz/DbconfigBiz.js';


export default {
    mounted() {
        this.query = this.$store.queryData["dbconfig"] || {};
        this.loadPage();
    },
    data() {
        return {
            ...
            columns: [
                ...
                { title: "连接地址", dataIndex: "url", ellipsis: true },
    ...
    methods: {
        ...
        queryData() {
            this.$store.setQueryData("dbconfig", this.query);
