...
export function Add(arg1:entity.AiChannel):Promise<model.HttpResult>;

export function Delete(arg1:string):Promise<model.HttpResult>;

export function Edit(arg1:entity.AiChannel):Promise<model.HttpResult>;

export function FindByUrl(arg1:string):Promise<model.HttpResult>;
